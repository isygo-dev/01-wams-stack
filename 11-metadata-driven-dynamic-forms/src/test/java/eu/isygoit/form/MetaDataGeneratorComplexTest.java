...
import eu.isygoit.form.view.EmployeeCreateForm;
...
class MetaDataGeneratorComplexTest {
    ...
    void shouldGenerateMetaDataWithNestedAndList() {
        ...
        assertThat(addressField.type()).isEqualTo(FieldType.OBJECT);
        ...
        assertThat(rolesField.type()).isEqualTo(FieldType.LIST);
