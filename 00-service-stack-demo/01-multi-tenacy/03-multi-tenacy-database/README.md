# Multi-Tenancy Database-Per-Tenant PoC
...
The Multi-Tenancy Database-Per-Tenant PoC showcases a scalable, tenant-aware architecture where each tenant's data is
