# multitenancy Schema-Per-Tenant PoC
...
- **GET /api/v1/tutorials**: Retrieve all tutorials or filter by title (case-insensitive).
...
- **GET /api/v1/tutorials/published**: Retrieve all published tutorials.
