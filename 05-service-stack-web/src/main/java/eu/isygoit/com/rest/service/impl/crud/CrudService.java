 ...
 */
@Slf4j
public abstract class CrudService<E extends AssignableId,
    ...
    public E createAndFlush(E object) {
        log.debug("Creating entity: {}", object);
        validateObject(object, false);
        return logAndExecute("Creating entity: {}", () -> afterCreate(getRepository().saveAndFlush(processObject(object))));
    }
    ...
    public E updateAndFlush(E object) {
        log.debug("Updating entity: {}", object);
        validateObject(object, true);
        return logAndExecute("Updating entity: {}", () -> afterUpdate(getRepository().saveAndFlush(processObject(object))));
    }
