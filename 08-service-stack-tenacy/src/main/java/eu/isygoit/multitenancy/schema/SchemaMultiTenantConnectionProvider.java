 ...
 * Uses a single DataSource and sets the schema dynamically per tenant.
 */
@Component
@ConditionalOnProperty(name = "multi-tenancy.mode", havingValue = "SCHEMA")
public class SchemaMultiTenantConnectionProvider implements MultiTenantConnectionProvider<String> {
     ...
     * Sets the schema using SET SCHEMA on the JDBC connection.
     */
    @Override
    ...
    /**
     * Called by Hibernate for tasks that are not tenant-specific (e.g. schema validation).
     */
    @Override
